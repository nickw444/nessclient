from typing import Tuple, Optional, Dict, Any, List, ParamSpec, Union
...
class SerialBase(io.RawIOBase):
    ...
    def readinto(self, b: Union[bytearray, memoryview, array.array[Any], mmap.mmap, _CData, PickleBuffer]) -> int: ...
...
class Serial(SerialBase, PlatformSpecific):
    ...
    def write(self, data: Union[bytes, Union[bytearray, memoryview, array.array[Any], mmap.mmap, _CData, PickleBuffer]]) -> int: ...
    def flush(self) -> None: ...
